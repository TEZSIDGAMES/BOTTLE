...
function setup() {
  ...
  ground = createSprite(750, 2040, 400, 20);
  ground.scale = 3;
...
function spawnObstacles() {
  if (frameCount % 100 === 0) {
    corona = createSprite(640, 1250, 20, 50);
    corona.addImage(coronaI);
    corona.scale = 0.36;
    corona.velocityX = -7;
    corona.velocityX = corona.velocityX-(6 + 3 * score / 100);
    corona.setCollider("circle",1,1,190);
